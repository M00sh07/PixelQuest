...
import { Lock, Check, X, TreeDeciduous } from "lucide-react";
import { 
  SkillNode, 
  SkillCategory, 
  SKILL_CATEGORIES,
      ...
      <div className="bg-card pixel-border p-6 max-w-lg w-full max-h-[80vh] overflow-y-auto">
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 bg-accent flex items-center justify-center pixel-border">
              <TreeDeciduous className="w-5 h-5 text-dungeon-dark" />
            </div>
            <div>
              <h2 className="text-sm text-primary pixel-text-shadow">Skill Trees</h2>
              <p className="text-[10px] text-muted-foreground uppercase">
                ⭐ {skills.skillPoints} Skill Points Available
              </p>
            </div>
          </div>
          <button
